    ...
    return (
        <>
                                    ...
                                    <table className="min-w-full divide-y divide-slate-200">
                                        <thead className="bg-slate-50">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">ปีงบประมาณ</th>
            ...
            <ProjectDetails
                ...
                icon={<ClipboardDocumentCheckIcon className="w-7 h-7 text-emerald-600" />}
            />
        </>
    );
};
