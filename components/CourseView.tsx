          ...
          <div className="border-t border-slate-200 mt-auto pt-4 text-slate-600 space-y-2 font-body text-sm">
            ...
            {course.syllabusLink && (
              <div className="flex items-center gap-2 text-blue-600">
                ...
                <a href={course.syllabusLink} target="_blank" rel="noopener noreferrer" className="truncate max-w-[200px] hover:underline hover:text-blue-800 transition-colors" onClick={(e) => e.stopPropagation()}>เอกสารหลักสูตร</a>
              </div>
            )}
          </div>
...
const CourseView: React.FC = () => { // Removed props
  ...
  const formView = (
    <Modal
      ...
      icon={<BookOpenIcon className="w-7 h-7 text-blue-600" />}
      maxWidth="max-w-4xl"
    >
  ...
  const detailsView = viewingCourse ? (
    <Modal
      ...
      icon={<BookOpenIcon className="w-7 h-7 text-emerald-600" />}
      maxWidth="max-w-4xl"
    >
          ...
          >
            ...
            <div className="relative flex items-center gap-6">
              ...
              <div className="text-left flex-1">
                <h3 className="text-xl font-bold mb-1 text-slate-800">เพิ่มหลักสูตร</h3>
                <p className="text-slate-600 text-sm font-normal">เพิ่มหลักสูตรอบรมใหม่สำหรับผู้ประกอบการ</p>
              </div>
