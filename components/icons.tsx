...
// Added Heroicons: CheckCircleIcon for success notifications
...
// Added Heroicons: XCircleIcon for error notifications
...
// Added Heroicons: ArrowLeftStartOnRectangleIcon for Logout
...
// Added Heroicons: HomeIcon for Dashboard
...
// Replaced with Heroicons: BuildingOffice2Icon
...
// Replaced with Heroicons: BriefcaseIcon
...
// Added Heroicons: ClipboardDocumentCheckIcon for Report Outcome
...
// Added Heroicons: ClipboardDocumentListIcon for BIZ Projects
...
// Replaced with Heroicons: BookOpenIcon
...
// Replaced with Heroicons: UserGroupIcon
export const UserGroupIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 18.75a4.5 4.5 0 019 0" />
  </svg>
);

// Added Heroicons: UserCircleIcon for user management
...
// Added Heroicons: Cog6ToothIcon for settings
export const Cog6ToothIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.26.713.53.967l.82 1.828a2.25 2.25 0 01.287 2.176l-.42 1.683c-.127.51-.56.942-1.11.942h-3.985c-.55 0-1.02-.398-1.11-.942l-.42-1.683a2.25 2.25 0 01.287-2.176l.82-1.828c.27-.254.467-.593.53-.967l.213-1.281z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.938 18c.099.542.56.94 1.11.94h2.593c.55 0 1.02-.398 1.11-.94l.213-1.281c.063-.374.26-.713.53-.967l.82-1.828a2.25 2.25 0 00-.287-2.176l-.42-1.683c-.127-.51-.56-.942-1.11-.942h-3.985c-.55 0-1.02.398-1.11.942l-.42 1.683a2.25 2.25 0 00.287 2.176l.82 1.828c.27.254.467.593.53.967l.213 1.281z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);


{/* FIX: Add missing Bars3Icon for mobile menu */ }
// Added Heroicons: Bars3Icon for mobile menu
...
// Added Heroicons: BellIcon for notifications
...
// Replaced with Heroicons: PlusIcon
...
// Replaced with Heroicons: XMarkIcon
...
// Replaced with Heroicons: MapPinIcon
...
// Replaced with Heroicons: PhoneIcon
...
// Replaced with Heroicons: PencilSquareIcon
...
// Replaced with Heroicons: TrashIcon
...
// Replaced with Heroicons: ExclamationTriangleIcon
...
// Added Heroicons: EyeIcon for View action
...
// Added Heroicons: Squares2X2Icon for Card View
...
// Added Heroicons: ListBulletIcon for List View
...
// Added Heroicons: SparklesIcon for AI Feature
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.562L16.25 21.75l-.648-1.188a2.25 2.25 0 01-1.47-1.47L13.5 18.75l1.188-.648a2.25 2.25 0 011.47-1.47L16.25 15l.648 1.188a2.25 2.25 0 011.47 1.47L18.75 18l-1.188.648a2.25 2.25 0 01-1.47 1.47z" />
  </svg>
);

// Added Heroicons: ChartBarIcon for Project Outcomes
...
// Added Heroicons: FunnelIcon for filtering
...
// Added Heroicons: ChevronDownIcon for dropdowns
...
// Added Heroicons: ChevronLeftIcon for Pagination
...
// Added Heroicons: ChevronRightIcon for Pagination
...
// Added Heroicons: ArrowLeftIcon for Back button
...
// Added Heroicons: MagnifyingGlassIcon for Search
...
// Added Heroicons: DocumentTextIcon for Full Report
...
// Added Heroicons: EllipsisVerticalIcon for Actions
...
// Added Heroicons: BuildingOffice2Icon for Entrepreneur
...
// Added Heroicons: CurrencyDollarIcon for Budget
...
// Added Heroicons: TagIcon for Category
...
// Added Heroicons: ArrowRightOnRectangleIcon for Logout
...
// Added Heroicons: DocumentArrowDownIcon for Export PDF
...
// Added Heroicons: PrinterIcon for Print
...
// Added Heroicons: TableCellsIcon for Excel Export
